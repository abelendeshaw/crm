...
export const teams: Team[] = [
  {
    id: "t1",
    name: "Software Solutions Pre-sales",
    department: "Pre-sales",
    branch: "Addis Ababa HQ",
    manager: "Sara Tesfaye",
    membersCount: 3,
    members: ["Sara Tesfaye", "Abel Girma", "Hana Worku"],
    description: "Pre-sales support for software product solutions and demos",
    createdAt: "2024-01-20",
  },
  {
    id: "t2",
    name: "IT Infrastructure Pre-sales",
    department: "Pre-sales",
    branch: "Addis Ababa HQ",
    manager: "Daniel Bekele",
    membersCount: 2,
    members: ["Daniel Bekele", "Tigist Alemu"],
    description: "Pre-sales for IT infrastructure, networking and hardware",
    createdAt: "2024-02-05",
  },
  {
    id: "t3",
    name: "System and Cloud Pre-sales",
    department: "Pre-sales",
    branch: "Addis Ababa HQ",
    manager: "Biruk Mekonnen",
    membersCount: 2,
    members: ["Biruk Mekonnen", "Liya Solomon"],
    description: "Pre-sales for systems, virtualization and cloud platforms",
    createdAt: "2024-02-15",
  },
  {
    id: "t4",
    name: "EN CS Pre-sales",
    department: "Pre-sales",
    branch: "Addis Ababa HQ",
    manager: "Meron Haile",
    membersCount: 2,
    members: ["Meron Haile", "Yonas Tadesse"],
    description: "Pre-sales for Enterprise Networking and Collaboration Systems",
    createdAt: "2024-03-01",
  },
  {
    id: "t5",
    ...
    manager: "Nahom Esrael",
    membersCount: 1,
    members: ["Nahom Esrael"],
    description: "Partner and channel program management",
    createdAt: "2024-01-20",
  },
  {
    id: "t6",
    name: "Service Solutions Pre-sales",
    department: "Pre-sales",
    branch: "Addis Ababa HQ",
    manager: "Hana Worku",
    membersCount: 1,
    members: ["Hana Worku"],
    description: "Pre-sales for managed services and professional services offerings",
    createdAt: "2024-05-20",
  },
  {
    id: "t7",
    name: "Public and Telecom Sales",
    department: "Sales",
    branch: "Addis Ababa HQ",
    manager: "Biruk Mekonnen",
    membersCount: 2,
    members: ["Biruk Mekonnen", "Yonas Tadesse"],
    description: "Sales coverage for public sector and telecom accounts",
    createdAt: "2024-06-01",
  },
  {
    id: "t8",
    name: "International and Corporate Sales",
    department: "Sales",
    branch: "Addis Ababa HQ",
    manager: "Sara Tesfaye",
    membersCount: 2,
    members: ["Sara Tesfaye", "Abel Girma"],
    description: "Sales for international and large corporate clients",
  ...
  },
  {
    ...
    manager: "Meron Haile",
    membersCount: 2,
    members: ["Meron Haile", "Liya Solomon"],
    description: "Sales for Banking, Financial Services and Insurance clients",
...
export const departments: Department[] = [
  {
    ...
    branch: "Addis Ababa HQ",
    head: "Sara Tesfaye",
    description: "Sales teams covering all customer segments and verticals",
    usersCount: 6,
    teamsCount: 3,
    status: "Active",
    createdAt: "2024-01-01",
  },
  {
    ...
    branch: "Addis Ababa HQ",
    head: "Daniel Bekele",
    description: "Pre-sales engineering and solution design teams",
    usersCount: 4,
    teamsCount: 6,
    status: "Active",
    createdAt: "2024-01-01",
